...
function submitHandler(event) {
    ...
    const formContainer = document.getElementById('creditForm');
    formContainer.classList.add('success-mode');
    formContainer.innerHTML = '<h2>You di it!</h2>';
}

document.querySelector('#creditForm').addEventListener('submit', submitHandler);